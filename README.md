...
[![x-cmd/install — har-viewer Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/har-viewer.svg)](https://x-cmd.com/install/har-viewer)
...
Total: **7,882** lines of code across **30** files in the top 5 languages.
...
- **Upstream**: <https://github.com/nassendelft/har-viewer>
- **License**: GPL-3.0
...
- **Releases**: 4 · **Merged PRs**: 0 · **Open PRs**: 0 · **Closed issues**: 0 · **Open issues**: 0 · **Commits**: 71
...
_Snapshot: `data/card/260926.yml` · 2026-09-26T04:31:09Z._
